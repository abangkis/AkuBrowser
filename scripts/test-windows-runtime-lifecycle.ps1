...
function Assert-Ready {
    ...
    Assert-True ($health.version -eq "0.7.8") "AkuBrowser runtime version is unexpected."
...
Assert-True ($acceptance.schemaVersion -eq 1 -and $acceptance.version -eq "0.7.8") "Lifecycle acceptance manifest is incompatible."
