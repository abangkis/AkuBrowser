...
Assert-True ($sidecarConfig.reasoning.evaluation.effort -eq "max") "Candidate evaluation must default to Luna Max."
...
Assert-True ($domain -match 'DefaultReasoningEvaluation\s*=\s*"luna_max"') "Evaluation profile default drifted."
