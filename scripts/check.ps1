...
Assert-True ($domain -match 'ApplicationVersion\s*=\s*"1\.0\.0-dev\.8"') "AkuSidecar version boundary is unexpected."
...
Assert-True ($supervised.health.expect.version -eq "1.0.0-dev.8") "AkuSupervisor expects the wrong AkuSidecar version."
