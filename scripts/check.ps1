...
Assert-True ($domain -match 'ApplicationVersion\s*=\s*"0\.7\.4"') "AkuSidecar version boundary is unexpected."
Assert-True ($releaseManifest.components.akuSidecar.version -eq "0.7.4") "AkuSidecar release manifest version is unexpected."
