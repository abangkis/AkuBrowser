...
Assert-True ($bridgePackage.akuRuntimeRevision -eq "source-fidelity-v48") "AkuBridge runtime revision is unexpected."
...
Assert-True ($supervised.health.expect.version -eq "1.0.0-dev.5") "AkuSupervisor expects the wrong AkuSidecar version."
