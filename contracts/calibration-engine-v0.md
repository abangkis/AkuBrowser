...
flowchart LR
  ...
  S --> C["Forced More/Less calibration"]
...
3. Every sampled entry must receive `more_like_this`, `less_like_this`, or a separate capture-issue report.
...
- Calibration labels are forced experimental observations; ordinary timeline More/Less signals remain optional contextual feedback.
