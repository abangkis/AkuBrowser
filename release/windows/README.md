# AkuBrowser Windows distribution — v0.9.0-rc.9

> **Release target:** v0.9.0-rc.9 is a published Windows x64 prerelease delivered
...
Use only the installer and checksum supplied by the v0.9.0 RC9 release evidence.
